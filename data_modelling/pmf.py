...
for filename in filenames:
 ...
 varholderdict[3.5] = 0.0
 varholderdict[4.0] = 0.0
 varholderdict[4.5] = 0.0
 varholderdict[5.0] = 0.0
 varholderdict[5.5] = 0.0
 varholderdict[6.0] = 0.0
 varholderdict[6.5] = 0.0
 varholderdict[7.0] = 0.0
 varholderdict[7.5] = 0.0
 varholderdict[8.0] = 0.0
 varholderdict[8.5] = 0.0
 varholderdict[9.0] = 0.0
 varholderdict[9.5] = 0.0
 varholderdict[10.0] = 0.0
 varholderdict[10.5] = 0.0
 ...
 for line in Lines:
  ...
  # varholderdict[3.5] += 1.0
  #elif (val >= 4.0) and (val < 4.5):
  # varholderdict[4.0] += 1.0
  #elif (val >= 4.5) and (val < 5.0):
  # varholderdict[4.5] += 1.0
  #elif (val >= 5.0) and (val < 5.5):
  # varholderdict[5.0] += 1.0
  #elif (val >= 5.5) and (val < 6.0):
  # varholderdict[5.5] += 1.0
  #elif (val >= 6.0) and (val < 6.5): 
  # varholderdict[6.0] += 1.00
  #elif (val >= 6.5) and (val < 7.0):
  # varholderdict[6.5] += 1.0
  #elif (val >= 7.0) and (val < 7.5):
  # varholderdict[7.0] += 1.0
  #elif (val >= 7.5) and (val < 8.0):
  # varholderdict[7.5] += 1.0
  #elif (val >= 8.0) and (val < 8.5):
  # varholderdict[8.0] += 1.0
  #elif (val >= 8.5) and (val < 9.0):
  # varholderdict[8.5] += 1.0
  #elif (val >= 9.0) and (val < 9.5):
  # varholderdict[9.0] += 1.0
  #elif (val >= 10.0) and (val < 10.5):
  # varholderdict[10.0] += 1.0
  #elif (val >= 10.5) and (val < 11.0):
  # varholderdict[10.5] += 1.0
