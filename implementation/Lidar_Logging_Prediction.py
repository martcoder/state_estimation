...
logfileRoot = "/home/pi/state_estimation/implementation/predictionL"+folderName+"/"
...
predictionFileNames = ["lprdct1.data","lprdct2.data","lprdct3.data","lprdct4.data","lprdct5.data","lprdct6.data","lprdct7.data","lprdct8.data","lprdct9.data","lprdct10.data","lprdct11.data","lprdct12.data","lprdct13.data","lprdct14.data","lprdct15.data","lprdct16.data","lprdct17.data","lprdct18.data","lprdct19.data","lprdct20.data","lprdct21.data","lprdct22.data","lprdct23.data","lprdct24.data","lprdct25.data","lprdct26.data","lprdct27.data","lprdct28.data","lprdct29.data","lprdct30.data","lprdct31.data","lprdct32.data","lprdct33.data","lprdct34.data","lprdct35.data","lprdct36.data","lprdct37.data","lprdct38.data","lprdct39.data","lprdct40.data"]
...
if __name__ == "__main__":
    try:
        ...
        while True:
            ...
            af = 0
            try:
              af = open( "/home/pi/state_estimation/implementation/LidarFlag.flag" )
            ...
            if (Lin == "zero") or (Lin == ''):
               ...
               if Lin != previousLogName: #continue if we have a new log to process
                  ...
                  SensorLines = []
                  try:
                    SensorData = open(Lin) #Lin should contain name of log file if one has been written
                    SensorLines = SensorData.readlines()
                    SensorData.close() # close it so it can be accessed by the logging script...
                  except FileNotFoundError:
                    errorF = open( errorFile,"a")
