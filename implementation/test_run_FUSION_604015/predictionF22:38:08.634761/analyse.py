...
plot.plot(f20,'o',color='green',label = "20psi predictions")
plot.plot(f60,'o',color='blue',label = "60psi predictions")
plot.plot(f40,'o',color='orange',label = "40psi predictions")
plot.legend()
plot.xlabel('Number of predictions')
plot.ylabel('Prediction Probability')
plot.title('Sensor Fusion Predictions for 40psi')
plot.show()

plot.plot(f20a,'o',color='green',label = "20psi predictions")
plot.plot(f60a,'o',color='blue',label = "60psi predictions")
plot.plot(f40a,'o',color='orange',label = "40psi predictions")
plot.legend()
plot.xlabel('Number of predictions')
plot.ylabel('Prediction Probability')
plot.title('Accelerometer Predictions for 40psi')
plot.show()

plot.plot(f20l,'o',color='green',label = "20psi predictions")
plot.plot(f60l,'o',color='blue',label = "60psi predictions")
plot.plot(f40l,'o',color='orange',label = "40psi predictions")
plot.legend()
plot.xlabel('Number of predictions')
plot.ylabel('Prediction Probability')
plot.title('Lidar Predictions for 40psi')
plot.show()
