...
plot.plot(f60a,'o',label = "60psi predictions")
plot.plot(f40a,'o',label = "40psi predictions")
plot.plot(f20a,'o',label = "20psi predictions")
plot.legend()
plot.xlabel('Number of predictions')
plot.ylabel('Prediction Probability')
...
plot.plot(f60l,'o',label = "60psi predictions")
plot.plot(f40l,'o',label = "40psi predictions")
plot.plot(f20l,'o',label = "20psi predictions")
plot.legend()
plot.xlabel('Number of predictions')
plot.ylabel('Prediction Probability')
